...
function printSingleMovie(string) {
  var api_key = "def69ea70c325d284197a405a3b78a5e";
...
function printLanguage(string) {
  var availableLangs = ["en", "it", "fr", "de", "pt", "zh", "es", "cs", "ja"];

  if (availableLangs.includes(string)) {
    string =
      '<img class="lang" src="img/flag-of-' + string + '.png" alt="language">';
  }
...
function printCastMovie(id) {
  $.ajax({
    ...
    method: "GET",
    data: {
      api_key: "def69ea70c325d284197a405a3b78a5e",
      language: "it-IT",
    },
    success: function (data) {
      var cast = data.cast;
